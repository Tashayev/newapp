...
// В случаи 2-го инстанса будим подставлять токены.
...
const authInterceptor = config => {
    ...
    return config
}// Токен получаем из локального хранилище по ключу токен


$authHost.interceptors.request.use(authInterceptor)//Вешаем интерцептер запроса на authHost
export {
    $host,
    $authHost
}